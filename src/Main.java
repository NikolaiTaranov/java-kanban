public class Main {
    ...
    public static void main(String[] args) {
        ...
        manager.updateTask(new Task("Покормить собаку","в 13:00", 2));
        manager.updateTask(new Task("Покормить собаку","в 13:00", 2));
        System.out.println(manager.returnTaskList());
        System.out.println("----------------------------------------\n");
        ...
        System.out.println("Создадим две сабтаски");
        ...
        System.out.println(manager.returnEpicList());
        System.out.println("Обновим сабтаску");
        manager.updateSubtask(new Subtask("Натянуть потолки1", "черные", 5, 4));
        manager.updateSubtask(new Subtask("Натянуть потолки1", "черные1", 5, 4));
        manager.updateSubtask(new Subtask("Положить плитку1", "белые", 6, 4));
